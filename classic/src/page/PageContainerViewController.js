Ext.define('Zan.data.page.PageContainerViewController', {
    ...
    init: function() {
        ...
        // Collection of Zan.data.page.BasePage components
        this._delayedCleanupQueue = new Ext.util.MixedCollection();

        // Track app state in the top-level view
        this.getViewModel().set('zanAppState', Zan.data.model.ZanAppStateModel.load('zan-app-state-instance'));
    },
    ...
    onRouteToPendingTargetPage: function(params) {
        ...
        // This handler is dynamically generated by Zan.data.Routing.toPage
        console.info("[ROUTING] to %o with zanRouteParams %o", this._pendingTargetPage, mergedParams);
    ...
    _activatePage: function(className, routeParams) {
        ...
        if (!(pageCmp instanceof Zan.data.page.BasePage)) {
            throw new Error("Routed page " + className + " must extend Zan.data.page.BasePage");
        }
        ...
        Ext.getApplication()
            .getMainView()
            .lookupViewModel()
            .get('zanAppState') // Instance of Zan.data.model.ZanAppStateModel
    ...
    _cacheView: function(component, params) {
        ...
        // Store in cache
        this._delayedCleanupQueue.add(cacheKey, component);
    },
